...
export async function GET(req: Request) {
  ...
  line("");
  line("By barber");
  line("Barber", "Revenue ($)", "Cuts", "Clients", "Avg time (min)", "No-shows", "Utilization (%)");
  for (const b of R.byBarber) line(b.name, money(b.revenue), b.appts, b.clients, b.avgServiceMin, b.noShow, b.utilization != null ? Math.round(b.utilization * 100) : "");
  line("");
  line("By service");
