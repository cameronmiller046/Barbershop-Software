        ...
        actions={
          <>
            ...
            <Select value={location} onChange={setLocation}
              options={[{ id: "all", label: "All Locations" }, ...LOCATIONS.map((l) => ({ id: l, label: l }))]} />
      ...
      <Drawer
        ...
        footer={selected && (
          <div className="grid grid-cols-3 gap-2">
            ...
            <button onClick={() => toast("Full payment history ships with the live feature", "info")} className="p-btn-ghost justify-center !px-2 text-xs">View History</button>
          </div>
        )}
      >
        {selected && (
