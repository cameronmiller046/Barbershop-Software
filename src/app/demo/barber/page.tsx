    ...
    <>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3 sm:mb-6">
        <div className="min-w-0">
          <h1 className="font-display text-xl text-cream sm:text-2xl">Hey {me.name.split(" ")[0]}</h1>
          <p className="mt-0.5 text-[13px] text-cream/50 sm:text-sm">{mine.length} on your chair today · {new Date().toLocaleDateString(undefined, { weekday: "short", month: "short", day: "numeric" })}</p>
        </div>
        {open ? (
