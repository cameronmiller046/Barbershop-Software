    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute left-0 top-[calc(100%+8px)] z-30 w-64 rounded-2xl border border-brass/25 bg-[#131217] p-2 shadow-2xl">
          ...
          <Link href="/demo/admin" className="flex w-full items-start gap-2.5 rounded-xl px-2.5 py-2.5 text-left transition hover:bg-brass/10">
          ...
          <Link href="/demo/barber" className="flex w-full items-start gap-2.5 rounded-xl px-2.5 py-2.5 text-left transition hover:bg-brass/10">
